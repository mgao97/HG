...
import hypergcn_cvae_pretrain_new_news20_full_1

from utils import load_data, accuracy, normalize_adj, normalize_features, sparse_mx_to_torch_sparse_tensor
# from gcn.models import GCN
from hypergcn_cvae_pretrain_new_news20_full_1 import HyperGCN
...
cvae_augmented_featuers, cvae_model = hypergcn_cvae_pretrain_new_news20_full_1.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
torch.save(cvae_model,"model/%s_hypergcn_0805.pkl"%args.dataset)
