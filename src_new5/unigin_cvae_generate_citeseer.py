...
from unigin_cvae_pretrain_new_citeseer import UniGIN
...
cvae_augmented_featuers, cvae_model = unigin_cvae_pretrain_new_citeseer.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
