...
from unisage_cvae_pretrain_coauthorshipcora import UniSAGE
...
cvae_augmented_featuers, cvae_model = unisage_cvae_pretrain_coauthorshipcora.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
torch.save(cvae_model,"model/%s_0805.pkl"%args.dataset)
torch.save(cvae_augmented_featuers,"model/%s_augmented_features_0805.pkl"%args.dataset)
