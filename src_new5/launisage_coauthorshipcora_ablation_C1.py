...
from hgcn import *
from hgcn.models import HGNN, UniSAGE, LAHGCN
...
cvae_model = torch.load("{}/model/{}_unisage_0805.pkl".format(exc_path, args.dataset)).to(device)
...
print('Ablation study with C1 on CoauthorshipCora dataset:')
print('\n')
