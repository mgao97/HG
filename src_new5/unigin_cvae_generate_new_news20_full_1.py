...
import unigin_cvae_pretrain_new_news20_full_1

from utils import load_data, accuracy, normalize_adj, normalize_features, sparse_mx_to_torch_sparse_tensor
# from gcn.models import GCN
from unisage_cvae_pretrain_new_news20_full_1 import UniSAGE
from tqdm import trange
import dhg
from dhg.data import *
from dhg import Hypergraph
from dhg.nn import HGNNConv,HyperGCNConv, UniGINConv
...
cvae_augmented_featuers, cvae_model = unigin_cvae_pretrain_new_news20_full_1.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
torch.save(cvae_model,"model/%s_unigin_0806.pkl"%args.dataset)
