...
from dhg.nn import HGNNConv,HyperGCNConv, UniSAGEConv
...
cvae_augmented_featuers, cvae_model = unisage_cvae_pretrain_new_news20_full_1.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
torch.save(cvae_model,"model/%s_unisage_0806.pkl"%args.dataset)
