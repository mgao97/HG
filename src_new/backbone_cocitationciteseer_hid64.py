...
for run in range(5):
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val:
                ...
                torch.save(net.state_dict(), 'model/bkhgnn_cocitationciteseer_hid64_0104.pth')
        # scheduler.step()
    print("\ntrain finished!")
    ...
    with torch.no_grad():
        ...
        # 保存到文件
        np.savetxt('res/bkhgnn_predicted_cociteseer_hid64_0104.txt', predicted_array, fmt='%d')
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val:
                ...
                best_val = val_acc
                best_state = deepcopy(net.state_dict())
                torch.save(net.state_dict(), 'model/bkhypergcn_cocitationciteseer_hid64_0104.pth')
        # scheduler.step()
    print("\ntrain finished!")
    print(f"best val: {best_val:.5f}")
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val:
                ...
                torch.save(model_unigin.state_dict(), 'bkunigin_cocitationciteseer_hid64_0104.pth')
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val:
                ...
                torch.save(model_unisage.state_dict(), 'bkunisage_cocitationciteseer_hid64_0104.pth')
