...
parser.add_argument('--dataset', default='senate',
                    help='Dataset string.')
...
cvae_augmented_featuers, cvae_model = hgnn_cvae_pretrain_new_senate.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
torch.save(cvae_model,"model/%s_0105.pkl"%args.dataset)
