...
parser.add_argument('--update_epochs', type=int, default=10, help='Update training epochs')
...
cvae_model = torch.load("{}/model/{}_0107.pkl".format(exc_path, args.dataset))
...
for i in trange(args.runs, desc='Run Train'):
    ...
    for epoch in range(args.epochs):
        ...
        if loss_val < best:
            ...
            torch.save(best_model.state_dict(), 'launisage_cociteseer_hid128_0107.pth')
