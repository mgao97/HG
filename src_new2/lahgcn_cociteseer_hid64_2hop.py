...
cvae_model = torch.load("{}/model/{}_0104_2hop.pkl".format(exc_path, args.dataset))
...
for i in trange(args.runs, desc='Run Train'):
    ...
    for epoch in range(args.epochs):
        ...
        if loss_val < best:
            ...
            torch.save(best_model.state_dict(), 'lahgnn_cociteseer_hid64_0106.pth')
    ...
    # 保存到文件
    np.savetxt('res/lahgnn_predicted_cociteseer_hid64_2hop_0106.txt', predicted_array, fmt='%d')
...
# # 从文件中读取预测结果
# predicted_array = np.loadtxt('res/lahgnn_predicted_cociteseer_hid64_2hop_0106.txt', dtype=int)
# # 将numpy数组转换为列表
...
# plt.savefig('figs/lahgnn_true_predic_cociteseer_hid64_2hop_0106.pdf')