...
parser.add_argument("--concat", type=int, default=6)
...
parser.add_argument('--tem', type=float, default=0.6, help='Sharpening temperature')
...
for i in trange(args.runs, desc='Run Train'):
    ...
    # # 保存到文件
    # np.savetxt('res/lahgnn_predicted_cociteseer_hid64_0104.txt', predicted_array, fmt='%d')
...
# # 从文件中读取预测结果
# predicted_array = np.loadtxt('res/lahgnn_predicted_cociteseer_hid64_0104.txt', dtype=int)
# # 将numpy数组转换为列表
...
# plt.savefig('figs/lahgnn_true_predic_cociteseer_hid64_0104.pdf')