...
cvae_augmented_featuers, cvae_model = hgnn_cvae_pretrain_new_highschool.get_augmented_features(args, G, X, labels, idx_train, features_normalized, device)
torch.save(cvae_model,"model/%s_hid20_0117.pkl"%args.dataset)
