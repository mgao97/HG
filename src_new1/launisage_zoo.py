...
cvae_model = torch.load("{}/model/{}_0104_lr.pkl".format(exc_path, args.dataset))
...
def get_augmented_features(concat):
    ...
    for _ in range(concat):
        ...
        augmented_features = hgnn_cvae_pretrain_new_zoo.feature_tensor_normalize(augmented_features).detach()
        if args.cuda:
