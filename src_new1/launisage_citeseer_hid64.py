...
parser.add_argument('--num_models', type=int, default=200, help='The number of models for choice')
...
cvae_model = torch.load("{}/model/{}_0106.pkl".format(exc_path, args.dataset))
